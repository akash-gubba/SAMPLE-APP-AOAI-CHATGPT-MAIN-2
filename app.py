...
def prepare_model_args(request_body, request_headers):
    ...
    file_content = request_body.get("fileContent", None)
    messages = []
    ...
    if file_content:
        print(file_content)
        messages.insert(1, {  # You can insert it at position 1 to prioritize it after the system message
            "role": "system",  # or "user" based on your needs
...
async def add_conversation():
    ...
    file_content = request_json.get("fileContent", None)
    ...
    try:
        ...
        if file_content:
            request_body["fileContent"] = file_content
