...
export type ConversationRequest = {
  messages: ChatMessage[],
  fileContent?: string | null        /////akash: Added the file content
}
...
export enum Feedback {
  ...
  NAT='Not_answering_to_the_point',
  AddInfo='Too_much_additional_information',
  techfunc='was_too_technical_while_i_expected_a_technical_response',
  functech='was_too_functional_while_i_expected_a_functional_response',
  Noref='reference_links_not_provided/not_working/Wrong',
  notRelated='The_response_is_not_related_to_hexagon_products'
}
